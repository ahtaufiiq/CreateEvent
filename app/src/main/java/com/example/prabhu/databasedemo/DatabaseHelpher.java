...
public class DatabaseHelpher extends SQLiteOpenHelper {
    ...
    private static final String STU_TABLE = "create table "+STUDENT_TABLE +"(name TEXT primary key,roll TEXT,address TEXT,branch TEXT)";
...
/* Insert into database*/
    public void insertIntoDB(String name,String roll,String address,String branch){
